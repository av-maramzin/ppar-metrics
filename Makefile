...
# local variables, locating llvm build in the system
LLVM_SRC_PATH := /disk/scratch/llvm
LLVM_BUILD_PATH := /disk/scratch/build
...
.PHONY: all
all: $(BUILD_DIR)/cc-comp 

.PHONY: cc-comp
cc-comp: $(BUILD_DIR)/cc-comp 

$(BUILD_DIR)/cc-comp: $(SRC_LLVM_DIR)/cc-comp.cpp
